...
# Los atributos de Alumno: nombre(cadena), numero_control(entero), carrera(cadena), calificaciones(flotante).
class Alumno:
    #Agregar
...
#Los atributos de Universidad: nombre(cadena), carreras(cadena), alumnos(cadena), profesores(cadena).
class Universidad:
...
#Los atributos de Carrera: nombre(cadena), materias(cadena)
class Carrera:
    def __init__(self, nombre: str):
        self.nombre = nombre
...
#Los atributos de Materia: nombre(cadena), carrera(cadena), calificacion_final(flotante).
class Materia:
...
#Los atributos de Profesor: nombre(cadena), materia(cadena).
class Profesor:
