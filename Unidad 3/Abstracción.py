...
bicicleta1=Bicicleta("Trek", "MTB", 2025, "Azul")

#Otras instancias
auto2 = Auto("Toyota", "Camry", 2020,"Blanco")
moto2 = Moto("Yamaha", "MT",2025,"Gris")
camion2 = Camion("Volvo", "FM",2022,"Negro")
bicicleta2=Bicicleta("Trek", "AXS",2021,"Morado")
